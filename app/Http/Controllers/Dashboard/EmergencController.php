...
use App\Models\Emergenc;
use App\Models\FirstAid;
use Illuminate\Http\Request;
use Illuminate\Validation\Rule;
use Yajra\DataTables\DataTables;

class EmergencController extends BackEndController
{
    public function __construct(Emergenc $model)
    {
    ...
    {
        $first_aid = Emergenc::select('id')->withTranslation()->get();
        $module_name_plural = $this->getClassNameFromModel();
